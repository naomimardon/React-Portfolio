        ...
        <Grid container spacing={5}>
          ...
          <Grid item className="infoItem" xs={12}>
            <Typography>
              ...
              <p>During the course, I have gained proficiency in numerous technologies, including HTML, CSS, JavaScript, Node.js and React, and plan to build on these skills in the coming months.</p>
